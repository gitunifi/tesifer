<div id="hotspot-container" class="row" data-id="<?php echo $params["id"] ?>">
    <div class="col-lg-12">
        <h1 class="page-header"><a href="?page=hotspot">Punti di interesse</a> / <span id="hotspot-title"></span> <button type="button" id="update-hotspot" class="btn btn-success" style="float:right"><i class="fa fa-save"></i> Salva</button>
