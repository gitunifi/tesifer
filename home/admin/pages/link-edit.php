<div id="link-container" class="row">
    <div class="col-lg-12">
        <h1 class="page-header"><a href="?page=collegamenti">Collegamenti</a> / Modifica collegamento <button id="link-save" type="button" class="btn btn-success" style="float:right;"><i class="fa fa-save"></i> Salva</button></h1>
    </div>
    <div class="col-xs-12">
